...
public class PedidosDto {
    ...
    @Schema(description = "Identificador del pedido. Generado por el sistema; se ignora al crear un pedido.", example = "45")
    ...
    @Schema(description = "Precio total del pedido, sumando todos los productos solicitados.", example = "48000")
    private Integer precioTotal;

    @Schema(description = "Fecha en la que se realizó el pedido. Generada por el sistema; se ignora al crearlo.", example = "2026-08-10")
    private LocalDate fechaPedido;

    @Schema(description = "Descripción u observaciones adicionales del pedido.", example = "Sin cebolla, para llevar")
    private String descripcion;

    @Schema(description = "Listado de productos solicitados en el pedido.")
